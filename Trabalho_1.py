                    ...
                    if caminho[vizinho[0]][vizinho[1]] == 0: # Ponto ainda nao visitado
                        ...
                        if map[vizinho[0]][vizinho[1]] == '.':
                            ...
                            if value < min:
                                ...
                                next_step = vizinho
                                current = ponto
                        elif map[vizinho[0]][vizinho[1]] == 'D':
                            ...
                            value = caminho[ponto[0]][ponto[1]][1] + 20 + get_distance(vizinho, end)
                            if value < min:
                                min = value
                                next_step = vizinho
                                current = ponto
                        elif map[vizinho[0]][vizinho[1]] == 'M':
                            value = caminho[ponto[0]][ponto[1]][1] + 100 + get_distance(vizinho, end)
                            if value < min:
                                min = value
                                next_step = vizinho
                                current = ponto
...
etapas = [10,20,30,60,65,70,75,80,85,90,95,100,110,120,130,140,150,160,170,180,190,200,210,220,230,240,250,260]

agilidades = [1.5,1.4,1.3,1.2,1.1,1.0]

interface = Interface(200*5,105*7)
map = create_map('caverna_dragao_v2.txt')
